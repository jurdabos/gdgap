-- R1, R3, R7, R8: Type-2-style person dimension, InnoDB foil — distinct sex and gender-identity
-- attributes (R1), verbatim reported code r_sex_raw keeping reserve states distinguishable (R7),
-- sex_source provenance (R3), and validity intervals (R8) in row-oriented storage with the
